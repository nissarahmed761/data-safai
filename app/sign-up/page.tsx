  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (code === "form_identifier_exists") {
        ...
        setError("This password has been compromised. Choose a different one.")
      } else {
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              {pendingVerification
                ...
                : "Start cleaning your data with AI"}
            </p>
          </div>
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-shadow tracking-widest text-center font-mono"
                  placeholder="000000"
                  maxLength={6}
                />
              </div>
